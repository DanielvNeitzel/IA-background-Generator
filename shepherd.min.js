...
(function(G, ca) {
    ...
    function ub(a, b, c) {
        ...
        Ia(b).forEach(function(e) {
            if (!Ja(a, e) || Object.hasOwnProperty.call(a, e) && Object.propertyIsEnumerable.call(a, e))
    ...
    function fa(a) {
        ...
        if (!c) a: {
            ...
            if (-1 === navigator.userAgent.indexOf("Trident") || !y(a) || "fixed" !== H(a).position)
    ...
    function lc(a, b, c) {
        let {
            ...
            firstFocusableElement: h
        } = b, {
            focusableElements: k
        } = b, {
            labelId: m
        } = b, {
            lastFocusableElement: g
        } = b, {
            step: l
        } = b, {
            dataStepId: p
...
Z`
    ...
    class K {
        ...
        $on(a, b) {
            ...
            c.push(b);
            return () => {
                let a = c.indexOf(b); - 1 !== a && c.splice(a, 1)
            }
        }
        $set(a) {
